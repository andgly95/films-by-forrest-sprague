  ...
  return (
    <main className="bg-zinc-900 text-white">
      <section className="flex flex-col items-center justify-center min-h-screen">
        <h1 className="text-5xl font-bold mb-8 font-serif">Films by Forrest Sprague</h1>
        <p className="text-2xl mb-12 text-center max-w-3xl font-serif">
          Forrest Sprague is an American structuralist experimental filmmaker based in Manhattan.
        </p>
      </section>
...
<section className="flex flex-col items-center justify-center min-h-screen bg-zinc-800">
  <div className="max-w-4xl text-center">
    ...
    <div className="flex justify-center space-x-8">
      <a href="https://www.imdb.com/name/nm14280863/" className="text-amber-500 hover:text-amber-400 text-xl font-semibold font-serif">IMDb</a>
      <a href="https://vimeo.com/forrestsprague/" className="text-amber-500 hover:text-amber-400 text-xl font-semibold font-serif">Vimeo</a>
      <a href="https://letterboxd.com/forrest_s/" className="text-amber-500 hover:text-amber-400 text-xl font-semibold font-serif">Letterboxd</a>
    </div>
  </div>
</section>
    </main>
